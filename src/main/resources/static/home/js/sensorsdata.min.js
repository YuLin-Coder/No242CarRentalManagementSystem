!function (e, t) {
    ...
    function app_js_bridge() {
        function e(e) {
            n = e, _.isJSONString(n) && (n = JSON.parse(n)), s && (s(n), s = null, n = null)
        }
        ...
        window.sensorsdata_app_js_bridge_call_js = function (t) {
            ...
            return r(), t(), e ? void(null === n ? s = e : (e(n), n = null)) : n
        }
    }
    ...
    try {
        ...
        sd._t = sd._t || 1 * new Date, sd.has_load_sdk = !0, "object" != typeof JSON && (JSON = {}), function () {
            ...
            function str(e, t) {
                ...
                switch (c && "object" == typeof c && "function" == typeof c.toJSON && (c = c.toJSON(e)), "function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
                    ...
                    case"object":
                        ...
                        if (rep && "object" == typeof rep) for (i = rep.length, r = 0; r < i; r += 1) "string" == typeof rep[r] && (n = rep[r], s = str(n, c), s && a.push(quote(n) + (gap ? ": " : ":") + s)); else for (n in c) Object.prototype.hasOwnProperty.call(c, n) && (s = str(n, c), s && a.push(quote(n) + (gap ? ": " : ":") + s));
                        return s = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + o + "}" : "{" + a.join(",") + "}", gap = o, s
                }
            }
            ...
            "function" != typeof JSON.stringify && (meta = {
                ...
                function walk(e, t) {
                    var r, n, s = e[t];
                    if (s && "object" == typeof s) for (r in s) Object.prototype.hasOwnProperty.call(s, r) && (n = walk(s, r), void 0 !== n ? s[r] = n : delete s[r]);
        ...
        sd.para_default = {
            ...
            var r = ["www.baidu.", "m.baidu.", "m.sm.cn", "so.com", "sogou.com", "youdao.com", "google.", "yahoo.com/", "bing.com/", "ask.com/"],
        ...
        logger.info = function () {
            ...
            var e = (FuncProto.bind, ArrayProto.forEach), t = (ArrayProto.indexOf, Array.isArray), r = {},
                n = _.each = function (t, n, s) {
                    if (null == t) return !1;
                    if (e && t.forEach === e) t.forEach(n, s); else if (t.length === +t.length) {
                        for (var i = 0, a = t.length; i < a; i++) if (i in t && n.call(s, t[i], i, t) === r) return !1
                    } else for (var o in t) if (hasOwnProperty.call(t, o) && n.call(s, t[o], o, t) === r) return !1
                };
            ...
            for (var s = [], i = 0; i < e.length; i++) if (n.call(e, i)) {
                var a = e[i];
                t.call(r, a, i, e) && s.push(a)
            }
            return s
            ...
            for (var t, r = [], n = {}, s = 0; s < e.length; s++) t = e[s], t in n || (n[t] = !0, r.push(t));
            return r
            ...
            return _.isObject(e) ? (_.each(e, function (t, r) {
                ...
                _.isString(t) || _.isNumber(t) || _.isDate(t) || _.isBoolean(t) || _.isArray(t) || "$option" === r || (logger.info("\u60a8\u7684\u6570\u636e-", r, t, "-\u683c\u5f0f\u4e0d\u6ee1\u8db3\u8981\u6c42\uff0c\u6211\u4eec\u5df2\u7ecf\u5c06\u5176\u5220\u9664"), delete e[r])
            }), e) : e
            ...
            e = (e + "").replace(/\r\n/g, "\n").replace(/\r/g, "\n");
            var t, r, n, s = "", i = 0;
            for (t = r = 0, i = e.length, n = 0; n < i; n++) {
                var a = e.charCodeAt(n), o = null;
                a < 128 ? r++ : o = a > 127 && a < 2048 ? String.fromCharCode(a >> 6 | 192, 63 & a | 128) : String.fromCharCode(a >> 12 | 224, a >> 6 & 63 | 128, 63 & a | 128), null !== o && (r > t && (s += e.substring(t, r)), s += o, t = r = n + 1)
            }
            return r > t && (s += e.substring(t, e.length)), s
        }, _.base64Encode = function (e) {
            var t, r, n, s, i, a, o, c, u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", l = 0,
                d = 0, p = "", f = [];
            if (!e) return e;
            e = _.utf8Encode(e);
            do t = e.charCodeAt(l++), r = e.charCodeAt(l++), n = e.charCodeAt(l++), c = t << 16 | r << 8 | n, s = c >> 18 & 63, i = c >> 12 & 63, a = c >> 6 & 63, o = 63 & c, f[d++] = u.charAt(s) + u.charAt(i) + u.charAt(a) + u.charAt(o); while (l < e.length);
            ...
            var e = function () {
                ...
                var r, n, s = navigator.userAgent, i = [], a = 0;
                for (r = 0; r < s.length; r++) n = s.charCodeAt(r), i.unshift(255 & n), i.length >= 4 && (a = t(a, i), i = []);
            ...
            return function () {
                ...
                var s = e() + "-" + t() + "-" + r() + "-" + n + "-" + e();
                return s ? (just_test_distinctid_2 = 1, s) : (just_test_distinctid_2 = 2, (String(Math.random()) + String(Math.random()) + String(Math.random())).slice(2, 15))
            }
        }(), _.getQueryParam = function (e, t) {
            t = t.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]"), e = _.decodeURIComponent(e);
            var r = "[\\?&]" + t + "=([^&#]*)", n = new RegExp(r), s = n.exec(e);
            return null === s || s && "string" != typeof s[1] && s[1].length ? "" : _.decodeURIComponent(s[1]).replace(/\+/g, " ")
            ...
            function t(t, r, n) {
                var s = function (s) {
                    if (s = s || e(window.event)) {
                        ...
                        var i, a, o = !0;
                        return "function" == typeof n && (i = n(s)), a = r.call(t, s), !1 !== i && !1 !== a || (o = !1), o
                    }
                };
                return s
            }
            ...
            get: function (e) {
                for (var t = e + "=", r = document.cookie.split(";"), n = 0; n < r.length; n++) {
                    ...
                    if (0 == s.indexOf(t)) return _.decodeURIComponent(s.substring(t.length, s.length))
                }
                return null
                ...
                s && (o = "; secure"), document.cookie = e + "=" + encodeURIComponent(t) + a + "; path=/" + i + o
            }, remove: function (e, t) {
            ...
            }, e), e.timeout && (r.timeout = e.timeout), r.onreadystatechange = function () {
            ...
            function r(e, t) {
                ...
                return r === e ? n : (e = parseInt(e.substring(1), 10), n[e < 0 ? n.length + e : e - 1])
            }

            function n(e, r) {
                for (var n = e.charAt(0), s = r.split("&"), i = [], a = {}, o = [], c = e.substring(1), u = 0, l = s.length; u < l; u++) if (i = s[u].match(/(.*?)=(.*)/), i || (i = [s[u], s[u], ""]), "" !== i[1].replace(/\s/g, "")) {
                    if (i[2] = t(i[2] || ""), c === i[1]) return i[2];
                    o = i[1].match(/(.*)\[([0-9]+)\]/), o ? (a[o[1]] = a[o[1]] || [], a[o[1]][o[2]] = i[2]) : a[i[1]] = i[2]
                }
                return n === e ? a : a[c]
            }
            ...
            return function (t, s) {
                ...
                if (t = t.toString(), i = s.match(/^mailto:([^\/].+)/)) a.protocol = "mailto", a.email = i[1]; else {
                    if ((i = s.match(/(.*?)\/#\!(.*)/)) && (s = i[1] + i[2]), (i = s.match(/(.*?)#(.*)/)) && (a.hash = i[2], s = i[1]), a.hash && t.match(/^#/)) return n(t, a.hash);
                    if ((i = s.match(/(.*?)\?(.*)/)) && (a.query = i[2], s = i[1]), a.query && t.match(/^\?/)) return n(t, a.query);
                    if ((i = s.match(/(.*?)\:?\/\/(.*)/)) && (a.protocol = i[1].toLowerCase(), s = i[2]), (i = s.match(/(.*?)(\/.*)/)) && (a.path = i[2], s = i[1]), a.path = (a.path || "").replace(/^([^\/])/, "/$1").replace(/\/$/, ""), t.match(/^[\-0-9]+$/) && (t = t.replace(/^([^\/])/, "/$1")), t.match(/^\//)) return r(t, a.path.substring(1));
                    if (i = r("/-1", a.path.substring(1)), i && (i = i.match(/(.*?)\.(.*)/)) && (a.file = i[0], a.filename = i[1], a.fileext = i[2]), (i = s.match(/(.*)\:([0-9]+)$/)) && (a.port = i[2], s = i[1]), (i = s.match(/(.*?)@(.*)/)) && (a.auth = i[1], s = i[2]), a.auth && (i = a.auth.match(/(.*)\:(.*)/), a.user = i ? i[1] : a.auth, a.pass = i ? i[2] : void 0), a.hostname = s.toLowerCase(), "." === t.charAt(0)) return r(t, a.hostname);
                    e() && (i = a.hostname.match(e()), i && (a.tld = i[3], a.domain = i[2] ? i[2] + "." + i[3] : void 0, a.sub = i[1] || void 0)), a.port = a.port || ("https" === a.protocol ? "443" : "80"), a.protocol = a.protocol || ("443" === a.port ? "https" : "http")
                }
            ...
            switch (typeof t) {
                case"function":
                    var r = t();
                    return "" === r || "" === _.trim(r) ? "referrer\u89e3\u6790\u5931\u8d25" : r.indexOf(".") !== -1 ? r : "referrer\u89e3\u6790\u5931\u8d25";
                case"string":
                    return "" === t || "" === _.trim(t) ? "referrer\u89e3\u6790\u5931\u8d25" : t.indexOf(".") !== -1 ? t : "referrer\u89e3\u6790\u5931\u8d25";
                default:
                    return "" === e ? "" : "" === _.url("domain", e) ? "referrer\u89e3\u6790\u5931\u8d25" : _.url("domain", e)
            }
        }, _.ry = function (e) {
            ...
            if (document && "string" == typeof document.referrer) {
                if (0 === document.referrer.indexOf("http")) {
                    var t = _.getReferrerDomain(document.referrer), r = _.url("?", document.referrer), n = null;
                    for (var s in e) if (0 === t.indexOf(s) && "object" == typeof r) if (n = e[s], _.isArray(n)) {
            ...
            var t = sd.para.source_type.search, r = sd.para.source_type.social, n = document.referrer || "",
                s = _.info.pageProp.url;
            if (s) {
                var i = s.match(/(utm_source|utm_medium|utm_campaign|utm_content|utm_term)\=[^&]+/);
                return i && i[0] ? "\u4ed8\u8d39\u5e7f\u544a\u6d41\u91cf" : e(t, n) ? "\u81ea\u7136\u641c\u7d22\u6d41\u91cf" : e(r, n) ? "\u793e\u4ea4\u7f51\u7ad9\u6d41\u91cf" : "" === n ? "\u76f4\u63a5\u6d41\u91cf" : "\u5f15\u8350\u6d41\u91cf"
            }
            return "\u83b7\u53d6url\u5f02\u5e38"
        }, _.info = {
            initPage: function () {
                var e = _.getReferrer(), t = e ? _.url("hostname", e) : e, r = _.getReferrerDomain(e),
                    n = location.href, s = n ? _.url("hostname", n) : n, i = _.getCurrentDomain(n);
                e && !r && _.jssdkDebug("referrer_domain\u5f02\u5e38_" + e + "_" + r), i || _.jssdkDebug("url_domain\u5f02\u5e38_" + n + "_" + i), this.pageProp = {
                    referrer: e,
                    referrer_host: t,
                    referrer_domain: r,
                    url: n,
                ...
                e = e || "", t = t || "";
                var r = _.info.campaignParams(), n = {}, s = {};
                for (var i in r) (" " + source_channel_standard + " ").indexOf(" " + i + " ") !== -1 ? n[e + i] = r[i] : s[t + i] = r[i];
        ...
        dataSend.getSendUrl = function (e, t) {
            ...
            return e.indexOf("?") !== -1 ? e + "&data=" + encodeURIComponent(r) + "&ext=" + encodeURIComponent(n) : e + "?data=" + encodeURIComponent(r) + "&ext=" + encodeURIComponent(n)
        }, dataSend.getSendData = function (e) {
            var t = _.base64Encode(e), r = "crc=" + _.hashCode(t);
            return "data=" + encodeURIComponent(t) + "&ext=" + encodeURIComponent(r)
        }, dataSend.getInstance = function (e) {
            var t = {};
            t = !e.config || "image" !== e.config.send_type && "ajax" !== e.config.send_type && "beacon" !== e.config.send_type ? new this[sd.para.send_type](e) : new this[e.config.send_type](e);
            var r = t.start;
        ...
        sd.sendState = sendState, sendState.queue = _.autoExeQueue(), sendState.requestData = null, sendState.getSendCall = function (e, t, r) {
            ...
            var n = e;
            if (e = JSON.stringify(e), logger.info(n), this.requestData = {
                data: e,
                config: t,
                callback: r
            }, sd.para.use_app_track === !0 || "only" === sd.para.use_app_track) if ("object" == typeof SensorsData_APP_JS_Bridge && (SensorsData_APP_JS_Bridge.sensorsdata_verify || SensorsData_APP_JS_Bridge.sensorsdata_track)) SensorsData_APP_JS_Bridge.sensorsdata_verify ? SensorsData_APP_JS_Bridge.sensorsdata_verify(JSON.stringify(_.extend({server_url: sd.para.server_url}, n))) ? "function" == typeof r && r() : this.prepareServerUrl() : (SensorsData_APP_JS_Bridge.sensorsdata_track(JSON.stringify(_.extend({server_url: sd.para.server_url}, n))), "function" == typeof r && r()); else if (!/sensors-verify/.test(navigator.userAgent) && !/sa-sdk-ios/.test(navigator.userAgent) || window.MSStream) sd.para.use_app_track === !0 && this.prepareServerUrl(); else {
                var s = null;
                if (/sensors-verify/.test(navigator.userAgent)) {
                    ...
                    if (i && i[0] && "string" == typeof i[1] && 2 === i[1].split("?").length) {
                        ...
                        var a = null, o = null;
                        try {
                            a = _.url("hostname", sd.para.server_url), o = _.url("?project", sd.para.server_url) || "default"
                        } catch (c) {
                        }
                        a && a === i[0] && o && o === i[1] ? (s = document.createElement("iframe"), s.setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(JSON.stringify(_.extend({server_url: sd.para.server_url}, n)))), document.documentElement.appendChild(s), s.parentNode.removeChild(s), s = null, "function" == typeof r && r()) : this.prepareServerUrl()
                    }
                } else s = document.createElement("iframe"), s.setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(JSON.stringify(_.extend({server_url: sd.para.server_url}, n)))), document.documentElement.appendChild(s), s.parentNode.removeChild(s), s = null, "function" == typeof r && r()
            } else "mui" === sd.para.use_app_track ? _.isObject(window.plus) && window.plus.SDAnalytics && window.plus.SDAnalytics.trackH5Event && window.plus.SDAnalytics.trackH5Event(e) : this.prepareServerUrl()
        ...
        var saNewUser = {
            checkIsAddSign: function (e) {
                ...
                for (var e = _.info.pageProp.url_domain, t = _.info.pageProp.referrer_domain, r = ["$utm_source", "$utm_medium", "$utm_campaign", "$utm_content", "$utm_term"], n = store.getProps(), s = 0; s < r.length; s++) r[s] in n && delete n[r[s]];
                store.setProps(n, !0), "" === e && (e = "url\u89e3\u6790\u5931\u8d25"), "url\u89e3\u6790\u5931\u8d25" === e ? sd.register({
                    $latest_traffic_source_type: "url\u7684domain\u89e3\u6790\u5931\u8d25",
                    $latest_referrer: "url\u7684domain\u89e3\u6790\u5931\u8d25",
                    $latest_referrer_host: "url\u7684domain\u89e3\u6790\u5931\u8d25",
                    $latest_search_keyword: "url\u7684domain\u89e3\u6790\u5931\u8d25"
                }) : "referrer\u89e3\u6790\u5931\u8d25" === t ? sd.register({
                    $latest_traffic_source_type: "referrer\u7684domain\u89e3\u6790\u5931\u8d25",
                    $latest_referrer: "referrer\u7684domain\u89e3\u6790\u5931\u8d25",
                    $latest_referrer_host: "referrer\u7684domain\u89e3\u6790\u5931\u8d25",
                    $latest_search_keyword: "referrer\u7684domain\u89e3\u6790\u5931\u8d25"
                }) : e !== t && sd.register({
                ...
                var i = _.info.campaignParamsStandard("$latest_", "_latest_"), a = i.$utms, o = i.otherUtms;
                _.isEmptyObject(a) || sd.register(a), _.isEmptyObject(o) || sd.register(o)
            }
        }, saEvent = {};
        saEvent.checkOption = {
            ...
            saNewUser.checkIsAddSign(r), saNewUser.checkIsFirstTime(r), sd.para.debug_mode === !0 ? (logger.info(r), this.debugPath(JSON.stringify(r), t)) : sd.sendState.getSendCall(r, s, t)
        }, saEvent.debugPath = function (e, t) {
            var r = e, n = "";
            n = sd.para.debug_mode_url.indexOf("?") !== -1 ? sd.para.debug_mode_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : sd.para.debug_mode_url + "?data=" + encodeURIComponent(_.base64Encode(e)), _.ajax({
                url: n,
                type: "GET",
                cors: !0,
        ...
        var store = sd.store = {
            ...
            isReady: function (e) {
                ...
                function r() {
                    ...
                    for (var r in e) (" " + source_channel_standard + " ").indexOf(" " + r + " ") !== -1 ? t["$" + r] = e[r] : t[r] = e[r];
                    return t
                }
                ...
                for (var s in r) (" " + source_channel_standard + " ").indexOf(" " + s + " ") !== -1 ? n["$" + s] = r[s] : n[s] = r[s];
        ...
        sd.quick = function () {
            ...
            e = e || {};
            var s = null;
            return e.ele && (s = e.ele), e.event && (s = e.target ? e.target : e.event.target), r = r || {}, !(!s || "object" != typeof s) && (!s.href || /^javascript/.test(s.href) || s.target || s.download || s.onclick ? (sd.track(t, r), !1) : (e.event && n(e.event), void(e.ele && _.addEvent(e.ele, "click", function (e) {
                n(e)
            }))))
        ...
        var heatmap = {
            getDomIndex: function (e) {
                ...
                for (var t = 0, r = e.tagName, n = e.parentNode.children, s = 0; s < n.length; s++) if (n[s].tagName === r) {
                    if (e === n[s]) return t;
                    t++
                }
                return -1
                ...
                return e.id && "not_use_id" !== sd.para.heatmap.element_selector ? "#" + e.id : e.tagName.toLowerCase() + (~t ? ":nth-of-type(" + (t + 1) + ")" : "")
                ...
                var n = this.getDomSelector(t), s = _.getEleInfo({target: t});
                if (s.$element_selector = n ? n : "", sd.para.heatmap && sd.para.heatmap.custom_property) {
                ...
                "a" === r && sd.para.heatmap && sd.para.heatmap.isTrackLink === !0 ? _.trackLink({
                    event: e,
                    target: t
                }, "$WebClick", s) : sd.track("$WebClick", s)
                ...
                var e = function (e) {
                    ...
                    return t.timeout = e.timeout || 1e3, t.func = e.func, t.hasInit = !1, t.inter = null, t.main = function (e) {
                        ...
                        var r = {};
                        this.inter || (r.$viewport_position = document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop || 0, r.$viewport_position = Math.round(r.$viewport_position) || 0, r.$viewport_height = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight || 0, r.$viewport_width = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth || 0, r.$viewport_left = document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollLeft || 0, e ? t.main(r) : this.inter = setTimeout(function () {
                            t.main(r)
                        }, this.timeout))
                    }, t
                }, t = e({
                    timeout: 1e3, func: function (e) {
                        var t = document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollTop || 0,
                            r = new Date, n = r - this.current_time;
                        n > sd.para.heatmap.scroll_delay_time && t - e.$viewport_left === 0 && (e.$url = location.href, e.$title = document.title, e.$url_path = location.pathname, e.event_duration = parseInt(n) / 1e3, "$viewport_left" in e && delete e.$viewport_left, sd.track("$WebStay", e)), this.current_time = r
                    }
                });
                ...
                return !(!_.isObject(sd.para.heatmap) || "default" !== sd.para.heatmap.clickmap) && (!(_.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url()) && ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : sd.para.heatmap.collect_elements = "interact", void("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click", function (t) {
                    ...
                    if ("body" === s.toLowerCase() || "html" === s.toLowerCase()) return !1;
                    if (!n || !n.parentNode || !n.parentNode.children) return !1;
                    var i = n.parentNode.tagName.toLowerCase();
                    "a" === i || "button" === i ? e.start(r, n.parentNode, n.parentNode.tagName.toLowerCase()) : e.start(r, n, s)
                }) : _.addEvent(document, "click", function (t) {
                    var r = t || window.event;
                    if (!r) return !1;
                    var n = r.target || r.srcElement;
        ...
        !function () {
            ...
            "string" == typeof e && (e = window[e], null == e || "function" != typeof e && "object" != typeof e || "object" != typeof e.para || !e.para.is_debug || e.track && e.track("_js_sdk_error", {
