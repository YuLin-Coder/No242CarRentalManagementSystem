                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="get" action="adminList" role="form">
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <button style="position: absolute;left: -320px;top: 0px; width: 128px"
                                                    class="btn btn-default dropdown-toggle" id="search-btn"
                                                    data-toggle="dropdown" type="button" aria-haspopup="true"
                                                    aria-expanded="false">
                                                店铺|送车点名称 <#--<span class="caret"></span>-->
                                            </button>
                                            <ul style="position: absolute;left: -290px;top: 38px;"
                                                class="dropdown-menu">
                                                <li><a tabindex="-1" href="javascript:void(0)"
                                                       data-field="title">店铺|送车点名称</a></li>
                                            </ul>
                                        </div>
                                        <input style="position: absolute;left: -192px;top: 0px; width:190px" type="text"
                                               class="form-control" value="${shopName!""}" name="shopName"
                                               placeholder="请输入店铺|送车点名称">
                                        <div class="input-group-btn">
                            ...
                            <div class="card-body">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as releaseVehicleInformation>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align:middle;">${releaseVehicleInformation.user.shopName!""}</td>
                                ...
                                <#if pageBean.total gt 0>
                                    <ul class="pagination ">
                                        ...
                                        <#else>
                                            <li>
                                                <a href="adminList?shopName=${shopName!""}&brand=${brand!""}&currentPage=1">«</a>
                                            </li>
                                        </#if>
                                        <#list pageBean.currentShowPage as showPage>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="adminList?shopName=${shopName!""}&brand=${brand!""}&currentPage=${showPage}">${showPage}</a>
                                                </li>
                                            </#if>
                                        </#list>
                                        ...
                                        <#else>
                                            <li>
                                                <a href="adminList?shopName=${shopName!""}&brand=${brand!""}&currentPage=${pageBean.totalPage}">»</a>
                                            </li>
                                        </#if>
