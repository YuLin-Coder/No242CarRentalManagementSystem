...
<title>${siteName!""}|前台用户企业管理-编辑个人用户状态</title>
    ...
    <main class="lyear-layout-content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>编辑个人用户状态</h4></div>
              <div class="card-body">
                <form action="add" id="user-add-form" method="post" class="row">
                  <input type="hidden" name="id" value="${deskUserPn.id}">
                  <div class="input-group" style="margin-top:15px;margin-bottom:15px;padding-left:25px;">
                    ...
                    <input type="radio" name="status" value="1" <#if deskUserPn.deskUser.status == 1> checked </#if>>
                    <span>正常</span>
                    <label class="lyear-radio radio-inline radio-primary">
                    <input type="radio" name="status" value="0" <#if deskUserPn.deskUser.status == 0> checked </#if>>
                    <span>冻结</span>
                  </label>
                  </div>
