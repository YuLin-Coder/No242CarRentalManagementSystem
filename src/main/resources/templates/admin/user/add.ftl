...
<title>${siteName!""}|管理员管理-添加管理员</title>
              ...
              <div class="card-body">
                <form action="add" id="user-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="username" name="username" value="" placeholder="请输入登录名称" tips="请填写登录名称" />
                  </div>
                  <div class="input-group m-b-10">
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('管理员添加成功!',function(){
