                ...
                <form action="add" id="role-add-form" method="post" class="row">
                  ...
                  <div class="input-group" style="margin-top:15px;margin-bottom:15px;padding-left:25px;">
                    ...
                    <label class="lyear-radio radio-inline radio-primary" style="margin-left:30px;">
                      <input type="radio" name="type" value="0" <#if role.type == 0> checked </#if> >
                      <span>管理员</span>
                      <label class="lyear-radio radio-inline radio-primary">
                        <input type="radio" name="type" value="1" <#if role.type == 1> checked </#if>>
                        <span>店铺|送车点</span>
                  </div>
                  <div class="input-group m-b-10" style="margin-top:15px;margin-bottom:15px;padding-left:25px;">
                    状态：
                    <label class="lyear-radio radio-inline radio-primary" style="margin-left:30px;/*margin-top:15px;margin-bottom:15px;padding-left:25px;*/">
                    <input type="radio" name="status" value="1" <#if role.status == 1>checked</#if>>
                    <span>启用</span>
                    <label class="lyear-radio radio-inline radio-primary" style="margin-left:13px">
